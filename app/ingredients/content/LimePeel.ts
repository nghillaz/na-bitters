...
export default function LimePeel(): IIngredientContent {
  return {
    ...
    showForTesting: true,
    links: [
      { caption: "Wikipedia", url: "https://en.wikipedia.org/wiki/Persian_lime" },
    ],
    safety: { level: IngredientSafety.Safe },
    pairsWith: [IngredientType.OrangePeel, IngredientType.GrapefruitPeel, IngredientType.LemonPeel],
  };
}